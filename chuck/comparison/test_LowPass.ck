// "simple" test to verify the exact waveform through a low pass filter
...
Kiss32 noise => LPF phil => WvOut waveOut => blackhole;
...
me.dir() + "/test_LowPass.ck.wav" => waveOut.wavFilename;
3::second => now;
waveOut.closeFile;

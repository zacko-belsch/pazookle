// "simple" test to verify the exact waveform through a band reject filter
...
Kiss32 noise => BRF phil => WvOut waveOut => blackhole;
...
me.dir() + "/test_BandReject.ck.wav" => waveOut.wavFilename;
3::second => now;
waveOut.closeFile;

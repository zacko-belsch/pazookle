// "simple" test to verify the exact waveform through a high pass filter
...
Kiss32 noise => HPF phil => WvOut waveOut => blackhole;
...
me.dir() + "/test_HighPass.ck.wav" => waveOut.wavFilename;
3::second => now;
waveOut.closeFile;

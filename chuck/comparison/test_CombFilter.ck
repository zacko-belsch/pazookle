// "simple" test to verify the exact waveform through comb filtering, based on
// the example at chuck.cs.princeton.edu/doc/examples/basic/comb.ck
...
Kiss32 noise => Gain master => WvOut waveOut => blackhole;
master => Delay delay => master;

noise.seed(13013);
delayLen::samp => delay.delay;
Math.pow(radius,delayLen) => delay.gain;

me.dir() + "/test_CombFilter.ck.wav" => waveOut.wavFilename;
3::second => now;
waveOut.closeFile;
